...
export const CHORD_QUALITY_CATEGORIES: ChordQualityCategoryInfo[] = [
  ...
  },
  {
    ...
    qualities: ["7", "maj7", "min7", "dim7", "min7b5"],
  },
  {
    name: "Extended",
    description: "9th, 11th, and 13th chords",
    qualities: ["9", "maj9", "min9", "11", "maj11", "min11", "13", "maj13", "min13"],
  },
  {
    name: "Jazz/Altered",
...
export function getCategoryForQuality(quality: string): ChordQualityCategory | null {
  const category = CHORD_QUALITY_CATEGORIES.find((cat) => cat.qualities.includes(quality));
