...
- **2025-10-26**: Changed app font to Space Grotesk
  ...
  - Clean, modern geometric aesthetic throughout the entire application
  - Previous experiments with monospaced fonts: Space Mono, IBM Plex Mono, Fira Code, Inconsolata, Roboto Mono, JetBrains Mono
